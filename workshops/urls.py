...
urlpatterns = [
    ...
    path('science_workshop/create', v.ObjectCreate.as_view(updates = {'is_over':False,'organizer':None}, 
    ...
    path('science_workshop/<str:id>/update', v.ObjectUpdate.as_view(model = m.ScienceWorkshop,
    ...
    path('science_workshop/<str:id>/delete/', v.ObjectDelete.as_view(model = m.ScienceWorkshop, 
                                                                    url = 'archive_url',
    ...
    path('science_workshops/', v.ObjectsList.as_view(list_filters = {'is_over':False},
                                                    model = m.ScienceWorkshop, 
                                                    template = 'workshops_list.html',list_type = 'new'), 
                                                    name='science_workshops'),
    path('archive/', v.ObjectsList.as_view(list_filters = {'is_over':True},
                                            model = m.ScienceWorkshop, 
